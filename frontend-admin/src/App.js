// src/App.js - Admin Panel (Electron + Web)
// Bu uygulama SADECE admin/HR sayfalarini icerir.
// Applicant (aday) kodlari YOKTUR - frontend-public'e tasindi.
...
// Izinler Sayfasi (placeholder)
const LeavesPage = () => (
    <Box p={3}>
        <h2>Izinler Sayfasi</h2>
        <p>Bu sayfa yapim asamasinda...</p>
    </Box>
);
    ...
    return (
        <Routes>
            ...
            <Route path="unauthorized" element={
                <AdminProtectedRoute><UnauthorizedPage /></AdminProtectedRoute>
            } />
            <Route path="settings" element={
                <AdminProtectedRoute><SettingsPage /></AdminProtectedRoute>
            } />
            <Route path="*" element={
...
const theme = createTheme({
    ...
    components: {
        ...
        MuiCard: { styleOverrides: { root: { borderRadius: '16px', transition: 'all 0.3s ease' } } }
    }
});
    ...
    return (
        <OptimaThemeProvider>
            <MuiThemeProvider theme={theme}>
                ...
                <Router>
                    <Routes>
                        {/* ADMIN SYSTEM - Sadece admin route'lar */}
